...
//! ============> If Api fails then stop the loader
    ...
    //! ============> Call api
    await _getRequest(
      endPoint: NetworkStrings.getAllPlayLists,
      context: context,
    );
  ...
  void _getPlaylistByUserIdSuccessResponse(
    ...
    try {
      final dataModel =
          GetPlaylistByUserId.fromJson(_response?.data, imageHai: true);

      GetxController.Get.find<HomeController>().recomdendedPlayList.value =
          dataModel;

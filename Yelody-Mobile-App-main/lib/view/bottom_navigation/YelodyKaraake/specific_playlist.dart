...
import 'package:yelody_app/res/components/addSongChoices.dart';
...
class SpecificPlaylist extends StatefulWidget {
  const SpecificPlaylist({super.key});

  @override
  State<SpecificPlaylist> createState() => _SpecificPlaylistState();
}

class _SpecificPlaylistState extends State<SpecificPlaylist> {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  searchresult(text: 'Ariana Grande',),
                  SizedBox(
                    height: 18.h,
                  ),
                                   searchresult(text: 'Morgan Wallen',),
                 
                  SizedBox(
                    height: 18.h,
                  ),
                                   searchresult(text: 'Justin Bieber',),
                  SizedBox(
                    height: 18.h,
                  ),
                                   searchresult(text: 'Drake',),
                  SizedBox(
                    height: 18.h,
                  ),
                                   searchresult(text: 'Olivia Rodrigo',),
                  SizedBox(
                    height: 18.h,
                  ),
                ],
